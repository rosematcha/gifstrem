...
const LoginPage = () => {
    ...
    return (_jsxs("div", { className: "flex min-h-screen flex-col items-center justify-center bg-charcoal px-4 text-white", children: [_jsxs(Link, { to: "/", className: "font-display text-4xl mb-8 hover:text-softViolet", children: [_jsx("span", { className: "text-white", children: "GIF" }), _jsx("span", { className: "text-violet", children: "strem" })] }), _jsxs("form", { className: "w-full max-w-md space-y-m rounded-modal bg-graphite border border-slate/30 p-l shadow-medium", onSubmit: handleSubmit, children: [_jsx("h1", { className: "text-2xl font-semibold", children: "Welcome back" }), error && _jsx("p", { className: "rounded-btn bg-coral/20 border border-coral/40 p-2 text-sm text-white", children: error }), _jsxs("label", { className: "block text-sm font-semibold text-coolGray", children: ["Your slug", _jsx("input", { type: "text", className: "mt-1 w-full rounded-btn border border-slate bg-graphite p-2 text-white placeholder-dimGray lowercase focus:border-violet focus:outline-none", placeholder: "", value: form.slug, onChange: (event) => {
                                ...
                                }, required: true })] }), _jsxs("label", { className: "block text-sm font-semibold text-coolGray", children: ["Password", _jsx("input", { type: "password", className: "mt-1 w-full rounded-btn border border-slate bg-graphite p-2 text-white placeholder-dimGray focus:border-violet focus:outline-none", value: form.password, onChange: (event) => {
