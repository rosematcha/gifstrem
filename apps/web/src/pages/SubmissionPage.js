...
const SubmissionPage = () => {
    ...
    return (_jsx("div", { className: "min-h-screen bg-charcoal px-4 py-xl text-white", children: _jsxs("div", { className: "mx-auto flex max-w-xl flex-col gap-l rounded-card bg-graphite border border-slate/30 p-l shadow-medium", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm uppercase text-violet font-semibold tracking-wide", children: "Submitting to" }), _jsx("h1", { className: "text-3xl font-bold", children: data.displayName })] }), status === 'success' && _jsx("p", { className: "rounded-btn bg-emerald/20 border border-emerald/40 p-2 text-white", children: "Thanks! Your GIF is pending approval." }), status === 'error' && error && _jsx("p", { className: "rounded-btn bg-coral/20 border border-coral/40 p-2 text-white", children: error }), _jsxs("form", { className: "space-y-m", onSubmit: handleSubmit, children: [_jsxs("label", { className: "block text-sm font-semibold text-coolGray", children: ["Your name", _jsx("input", { type: "text", value: uploaderName, onChange: (event) => {
